...
GUA = [1054295664, 1860375797, 712277262]
...
💭 Selamat Datang di Uputt Userbot.</b>""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(text="🐣 Admin 1", url=f"https://t.me/iamuput"),
                    InlineKeyboardButton(text="🐣 Admin 2", url=f"https://t.me/uputraa"),
                ],
                  [
...
@app.on_message(filters.command("restart") & ~filters.via_bot)
...
@Client.on_message(filters.command("ress", cmds) & filters.me)
async def restart_bot(_, message: Message):
    try:
