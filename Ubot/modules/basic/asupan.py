...
async def ay(client, message):
    ...
    await message.reply_photo(
        ...
        False,
        caption=f"Ayangnya {client.me.mention} 🥰",
    )
...
async def pcp(client, message):
    ...
    await message.reply_photo(
        ...
        False,
        caption=f"📌 PP Couple nya Nih Kak {client.me.mention}",
    )
...
async def anim(client, message):
    ...
    await message.reply_photo(
        ...
        False,
        caption=f"📌 PP Anime nya Nih Kak {client.me.mention}",
    )
