...
@Client.on_message(filters.command(["ange", "sange"], cmds) & filters.me)
async def piciieess(client: Client, message: Message):
...
@Client.on_message(filters.command(["lipkol", "sleepcall"], cmds) & filters.me)
...
@Client.on_message(filters.command(["nakal", "bandel"], cmds) & filters.me)
...
@Client.on_message(
    filters.command("spongebob", cmds) & filters.me
)
...
@Client.on_message(filters.command("ular", cmds) & filters.me)
...
add_command_help(
    ...
    [
        ...
        ["spongebob", "Untuk menampilkan art spongebob."],
        ["ular", "Untuk menampilkan art ular."],
